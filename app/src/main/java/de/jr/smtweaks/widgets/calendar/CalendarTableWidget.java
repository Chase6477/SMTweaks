...
public class CalendarTableWidget extends AppWidgetProvider {
    private final int[] headerIDs = {R.id.header1, R.id.header2, R.id.header3, R.id.header4, R.id.header5};
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent activityIntent = new Intent(context, CalendarUpdateActivity.class);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (AppWidgetManager.ACTION_APPWIDGET_UPDATE.equals(intent.getAction())) {
            ...
            ComponentName thisWidget = new ComponentName(context, CalendarTableWidget.class);
    ...
    private void updateRemoteViewFormats(RemoteViews views, Context context) {
        ...
        if (!file.exists())
            views.setTextViewText(R.id.textView, "Last Update: Never");
        else {
            ...
            views.setTextViewText(R.id.textView, "Last Update: " + date + " " + time);
        }
    }
}
